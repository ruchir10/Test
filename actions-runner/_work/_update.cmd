...
set rootfolder=C:\Test\actions-runner
set existrunnerversion=2.305.0
set downloadrunnerversion=2.306.0
set logfile=C:\Test\actions-runner\_diag\SelfUpdate-20230712-115255.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "C:\Test\actions-runner\run.cmd"
) else (
  endlocal
)
